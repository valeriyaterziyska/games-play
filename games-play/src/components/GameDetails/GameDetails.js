...
export const GameDetails = () => {
    ...
    const onCommentSubmit = async (e) => {
        ...
        setGame(state => ({...state, comments: {...state.comments, [result.id]: result}}));
        setUsername('');
        setComment('');
    };
        ...
        <section id="game-details">
            ...
            <article className="create-comment">
                ...
                <form className="form" onSubmit={onCommentSubmit}>
                    ...
                    <textarea name="comment" placeholder="Comment......" value={comment} onChange={(e) => setComment(e.target.comment)}></textarea>
